...
# Step 2: Initialize the translation engine [cite: 23, 24]
translator = Translator()

# Step 3: UI Configuration and Header [cite: 22, 25]
...
# Step 6: Translation Logic and Output [cite: 24, 25]
    ...
    if text_to_translate.strip() == "":
        ...
        with st.spinner("Processing translation..."):
            try:
                ...
                # Display the response [cite: 25]
                st.success("Translation Complete!")
                st.subheader("Translated Text:")
                st.code(result.text, language='')
                
                # Optional: Extra Feature for better usability [cite: 26]
...
# Footer for internship identification
st.divider()
